...
#define MAX 1000 //Número de vértices do grafo

vector<int> adj[MAX]; //vetor de adjacências

int pai[MAX]; //array que guarda os pais de cada nó

// Backtracking é um refinamento do algoritmo de força bruta (enumeração exaustiva)
void dfs(int v){
	for(auto x: adj[v]){
